...
export const DISHES = [
  {
    image: d1,
    title: "Chicken Fry",
    description: "Succulent and tender, chicken elevates any dish",
  },
  {
    image: d2,
  ...
  },
  {
    image: d9,
    title: "Fish Fry",
    description: "Crispy and golden, fish fry delights every bite",
  },
  {
    image: d10,
    title: "Prawn Fry",
    description:
      "Spicy and crispy, prawn fry is pure indulgence",
  },
];
...
export const REVIEW = {
  ...
  content:
    "“Restaura is a nice place to eat. The inside is beautiful, and the food tastes amazing. I really enjoyed my visit and would happily go again.”",
};

export const CONTACT = [
  { key: "address", value: "Address: 123 Main Street, Coimbatore, India, 641659" },
